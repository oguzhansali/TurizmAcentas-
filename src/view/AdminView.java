...
public class AdminView extends Layout {
    ...
    public AdminView(User user) {
        ...
        // Kullanıcı yoksa pencereyi kapatır
        if (this.user == null) {
            dispose();
        }
        this.lbl_welcome.setText("Hoşgeldiniz : " + this.user.getUsername());

        loadUserTable(); // Kullanıcı tablosunu yükler
        loadUserComponent();// Kullanıcı bileşenlerini yükler
        loadUserFilter();// Kullanıcı filtresini yükler


        // Kullanıcı tablosunda sağ tıklamayı dinler ve kullanıcı menüsünü gösterir
